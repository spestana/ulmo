...
def test_get_site_data_single_site_with_start_and_end():
    ...
    site_data = ulmo.usgs.nwis.get_site_data(site_code, start='2011-11-05',
                end='2011-11-18', service='instantaneous', methods='all')
...
def test_get_site_data_multiple_methods():
    ...
    # with test_util.mocked_urls(site_data_file):
    site_data = ulmo.usgs.nwis.get_site_data(site_code, methods={'62614': 'all'})
    assert len(site_data['62614:00003:133482']['values']) == 1
    assert len(site_data['62614:00003:133488']['values']) == 1
